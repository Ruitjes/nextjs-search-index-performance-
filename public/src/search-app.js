...
Promise.all([
  ...
  fetch('file:///C:/Users/stanr/Desktop/Aviva%20Solutions/Documenten/Onderzoek%20Search%20Index/search-index-demo/search-index/demo/generate-index/EarthPorn-top-search-index.json').then(res => res.json())
]).then(([thisSi, dump]) => {
